    ...
    <div class="card wow animate__animated animate__fadeInUp" data-wow-duration="1s">
        ...
        @if(!empty ($module->data['button_text']))
            @if($module->data['button_type'] == 'Link'))
                <a class="modal-button" href="{{$module->data['button_url']}}">{{$module->data['button_text']}}</a>
            @else
        ...
        <div class="contenido-modal">
                ...
                <div class="item">
                    ...
                    <div class="right">
                        ...
                        @empty(!$module->data['second_account']['button_text'])
                            <a href="{{$module->data['second_account']['button_url']}}" class="link">{{$module->data['second_account']['button_text']}}</a>
                        @endempty
                    </div>
                </div>
            @endif
            ...
            <div class="item">
                ...
                <div class="right">
                    ...
                    <a href="{{$module->data['box']['button_url']}}" class="link">{{$module->data['box']['button_text']}}</a>
                    @endempty
                </div>
            </div>
            @endif
                ...
                <div class="right">
                    ...
                    <div class="list">
                        @empty(!$module->data['list']['product_1'])
                            <a href="{{$module->data['list']['product_url_1']}}">
                        ...
                        @empty(!$module->data['list']['product_2'])
                            <a href="{{$module->data['list']['product_url_2']}}">
                        ...
                        @empty(!$module->data['list']['product_3'])
                            <a href="{{$module->data['list']['product_url_3']}}">
                        ...
                        @empty(!$module->data['list']['product_4'])
                            <a href="{{$module->data['list']['product_url_4']}}">
                        ...
                        @empty(!$module->data['list']['product_5'])
                            <a href="{{$module->data['list']['product_url_5']}}">
                        ...
                        @empty(!$module->data['list']['product_6'])
                            <a href="{{$module->data['list']['product_url_6']}}">
