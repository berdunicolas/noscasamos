@if ($module->data['type_button'] == "Confirmar Asistencia")
    @if($confirmation->data['form_type'] == 'link') {
        <a href="https://{{$confirmation->data['form_button_url']}}" class="linkcontacto" style="background-color:{{$color}}; z-index:1000;" target="_blank"><i class="fa-light {{$module->data['icon_button']}}" style="font-size:24px;"></i></a>
    @else
    ...
    @endif
@else
    <a href="https://{{$module->data['url_button']}}" class="linkcontacto" style="background-color:{{$color}}; z-index:1000;" target="_blank"><i class="fa-light {{$module->data['icon_button']}}" style="font-size:24px;"></i></a>
@endif
